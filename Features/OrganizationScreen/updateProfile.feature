Feature: Verify update profile page
  ...
  Scenario Outline: Upload profile picture and verify toast message
    ...
    Examples: 
      ...
      | Successfully logged in. | Please select a File | Profile Picture added successfully | C:\\Users\\Softsuave\\BustlespotAutomation2024\\Bustlespot\\resources\\profilePhoto.png |