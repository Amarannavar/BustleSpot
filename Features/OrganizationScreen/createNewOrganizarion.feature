Feature: Verifying organization module
  ...
  Scenario Outline: Creating new organization and verify toast message
    ...
    Examples: 
      ...
      | Successfully logged in. | Organsiation has been created successfully. | Softsuave org     | Verify to create new organization | C:\\Bustlespot\\Bustlespot\\resources\\soft_suave_logo.jpg |
      | Successfully logged in. | Organization already present                | Softsuave org     | Verify to create new organization | C:\\Bustlespot\\Bustlespot\\resources\\soft_suave_logo.jpg |
